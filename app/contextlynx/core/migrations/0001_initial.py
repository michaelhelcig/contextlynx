    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('word_embedding', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.wordembedding')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_type', models.CharField(choices=[('TEXT', 'Text'), ('LINK', 'Link')], max_length=4)),
